__kernel void builtin_rootn_float16(__global float *dst,  __global float *src1, __global int *src2, __global int *vector) {
  ...
  int16 x2 = (int16) (src2[i * (*vector) + 0],src2[i * (*vector) + 1],src2[i * (*vector) + 2],src2[i * (*vector) + 3],src2[i * (*vector) + 4],src2[i * (*vector) + 5],src2[i * (*vector) + 6],src2[i * (*vector) + 7],src2[i * (*vector) + 8],src2[i * (*vector) + 9],src2[i * (*vector) + 10],src2[i * (*vector) + 11],src2[i * (*vector) + 12],src2[i * (*vector) + 13],src2[i * (*vector) + 14],src2[i * (*vector) + 15]);
