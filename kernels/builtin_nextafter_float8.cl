__kernel void builtin_nextafter_float8(__global float *dst,  __global float *src1, __global float *src2, __global int *vector) {
  ...
  float8 x2 = (float8) (src2[i * (*vector) + 0],src2[i * (*vector) + 1],src2[i * (*vector) + 2],src2[i * (*vector) + 3],src2[i * (*vector) + 4],src2[i * (*vector) + 5],src2[i * (*vector) + 6],src2[i * (*vector) + 7]);
