...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_reduce_add_int);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_reduce_add_long);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_reduce_min_int);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_reduce_min_long);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_scan_inclusive_add_int);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_scan_inclusive_add_long);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_scan_inclusive_min_int);
...
MAKE_BENCHMARK_FROM_FUNCTION(benchmark_workgroup_scan_inclusive_min_long);
